...
-
Réalisé par : Oussarhan Ikram (SMA-S4) & Ourahou Fatiha (SMI-S4).
-
...
Structure de données : 
-
Notre programme est composé de plusieurs structures de données :
...
Fonctionnalités : 
-
Notre programme offre plusieurs fonctionnalités pour interagir avec la bibliothèque :
